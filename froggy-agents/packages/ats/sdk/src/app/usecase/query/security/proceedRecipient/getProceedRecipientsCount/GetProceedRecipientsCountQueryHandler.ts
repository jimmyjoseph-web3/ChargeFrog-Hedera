...
export class GetProceedRecipientsCountQueryHandler
  implements IQueryHandler<GetProceedRecipientsCountQuery>
{
  constructor(
  ...
  async execute(
    query: GetProceedRecipientsCountQuery,
  ): Promise<GetProceedRecipientsCountQueryResponse> {
    try {
      ...
      const res =
        await this.queryAdapter.getProceedRecipientsCount(securityEvmAddress);
