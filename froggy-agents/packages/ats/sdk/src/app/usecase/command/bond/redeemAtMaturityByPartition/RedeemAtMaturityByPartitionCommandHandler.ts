...
export class RedeemAtMaturityByPartitionCommandHandler
  implements ICommandHandler<RedeemAtMaturityByPartitionCommand>
{
  constructor(
  ...
  async execute(
    command: RedeemAtMaturityByPartitionCommand,
  ): Promise<RedeemAtMaturityByPartitionCommandResponse> {
    try {
      ...
      return Promise.resolve(
        new RedeemAtMaturityByPartitionCommandResponse(
          res.error === undefined,
          res.id!,
        ),
      );
