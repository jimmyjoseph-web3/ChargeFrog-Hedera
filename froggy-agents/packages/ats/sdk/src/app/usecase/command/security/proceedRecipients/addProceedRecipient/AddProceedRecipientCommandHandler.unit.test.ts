...
describe('AddProceedRecipientCommandHandler', () => {
  ...
  beforeEach(() => {
    handler = new AddProceedRecipientCommandHandler(
      accountServiceMock,
      transactionServiceMock,
      validationServiceMock,
      contractServiceMock,
    );
    command = AddProceedRecipientCommandFixture.create();
  });
  ...
  describe('execute', () => {
    ...
    it('should successfully add proceedRecipientiary', async () => {
      ...
      expect(result).toBeInstanceOf(AddProceedRecipientCommandResponse);
