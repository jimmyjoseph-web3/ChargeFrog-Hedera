  ...
  describe('execute', () => {
    describe('error cases', () => {
      it('throws ControllerRedeemCommandError when command fails with uncaught error', async () => {
        ...
        await expect(resultPromise).rejects.toBeInstanceOf(
          ControllerRedeemCommandError,
        );

        await expect(resultPromise).rejects.toMatchObject({
          message: expect.stringContaining(
            `An error occurred while force redeeming tokens: ${errorMsg}`,
          ),
    ...
    describe('success cases', () => {
      it('should successfully force redeem tokens', async () => {
        ...
        expect(
          transactionServiceMock.getHandler().controllerRedeem,
