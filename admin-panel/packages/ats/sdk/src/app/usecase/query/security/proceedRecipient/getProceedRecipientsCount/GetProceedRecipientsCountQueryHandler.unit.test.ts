...
describe('GetProceedRecipientsCountQueryHandler', () => {
  ...
  beforeEach(() => {
    handler = new GetProceedRecipientsCountQueryHandler(
      contractServiceMock,
  ...
  describe('execute', () => {
    it('throws GetProceedRecipientsCountQueryError when query fails with uncaught error', async () => {
      ...
      await expect(resultPromise).rejects.toBeInstanceOf(
        GetProceedRecipientsCountQueryError,
      );

      await expect(resultPromise).rejects.toMatchObject({
        message: expect.stringContaining(
          `An error occurred while querying GetProceedRecipientsCount: ${errorMsg}`,
        ),
    ...
    it('should successfully get proceedRecipients count', async () => {
      ...
      queryAdapterServiceMock.getProceedRecipientsCount.mockResolvedValueOnce(
        responseAdapter,
      );
      ...
      expect(
        queryAdapterServiceMock.getProceedRecipientsCount,
