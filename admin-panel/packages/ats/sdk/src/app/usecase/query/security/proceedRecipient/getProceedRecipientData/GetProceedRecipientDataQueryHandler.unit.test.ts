...
import {
  GetProceedRecipientDataQuery,
  GetProceedRecipientDataQueryResponse,
} from './GetProceedRecipientDataQuery';
...
describe('GetProceedRecipientDataQueryHandler', () => {
  ...
  beforeEach(() => {
    handler = new GetProceedRecipientDataQueryHandler(
      contractServiceMock,
  ...
  describe('execute', () => {
    it('throws GetProceedRecipientDataQueryError when query fails with uncaught error', async () => {
      ...
      await expect(resultPromise).rejects.toBeInstanceOf(
        GetProceedRecipientDataQueryError,
      );

      await expect(resultPromise).rejects.toMatchObject({
        message: expect.stringContaining(
          `An error occurred while querying GetProceedRecipientData: ${errorMsg}`,
        ),
    ...
    it('should successfully get proceed recipient data', async () => {
      ...
      queryAdapterServiceMock.getProceedRecipientData.mockResolvedValueOnce(
        '0x123',
      );
      ...
      expect(
        queryAdapterServiceMock.getProceedRecipientData,
