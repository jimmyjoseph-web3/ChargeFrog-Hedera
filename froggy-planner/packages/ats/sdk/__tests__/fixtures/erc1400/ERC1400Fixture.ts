...
export const CanTransferQueryFixture = createFixture<CanTransferQuery>(
  (query) => {
    query.securityId.as(
      () => new HederaId(HederaIdPropsFixture.create().value),
    );
...
export const CanTransferByPartitionQueryFixture =
  createFixture<CanTransferByPartitionQuery>((query) => {
    query.securityId.as(
      () => new HederaId(HederaIdPropsFixture.create().value),
    );
    query.sourceId.as(() => new HederaId(HederaIdPropsFixture.create().value));
...
export const GetMaxSupplyQueryFixture = createFixture<GetMaxSupplyQuery>(
  (query) => {
    query.securityId.as(
      () => new HederaId(HederaIdPropsFixture.create().value),
    );
...
export const GetMaxSupplyByPartitionQueryFixture =
  createFixture<GetMaxSupplyByPartitionQuery>((query) => {
    query.securityId.as(
      () => new HederaId(HederaIdPropsFixture.create().value),
    );
    query.partitionId.as(() => PartitionIdFixture.create().value);
...
export const GetTotalSupplyByPartitionQueryFixture =
  createFixture<GetTotalSupplyByPartitionQuery>((query) => {
    query.securityId.as(
      () => new HederaId(HederaIdPropsFixture.create().value),
    );
    query.partitionId.as(() => PartitionIdFixture.create().value);
...
export const IsOperatorQueryFixture = createFixture<IsOperatorQuery>(
  (query) => {
    query.securityId.as(
      () => new HederaId(HederaIdPropsFixture.create().value),
    );
...
export const IsOperatorForPartitionQueryFixture =
  createFixture<IsOperatorForPartitionQuery>((query) => {
    query.securityId.as(
      () => new HederaId(HederaIdPropsFixture.create().value),
    );
    query.targetId.as(() => new HederaId(HederaIdPropsFixture.create().value));
