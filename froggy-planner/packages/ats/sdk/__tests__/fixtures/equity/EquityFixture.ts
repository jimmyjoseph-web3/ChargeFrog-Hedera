...
export const GetDividendHoldersQueryFixture =
  createFixture<GetDividendHoldersQuery>((query) => {
...
export const GetTotalDividendHoldersQueryFixture =
  createFixture<GetTotalDividendHoldersQuery>((query) => {
    query.securityId.as(() => HederaIdPropsFixture.create().value);
    query.dividendId.faker((faker) => faker.number.int({ min: 1, max: 10 }));
  });

export const GetVotingHoldersQueryFixture =
  createFixture<GetVotingHoldersQuery>((query) => {
    query.securityId.as(() => HederaIdPropsFixture.create().value);
...
export const GetTotalVotingHoldersQueryFixture =
  createFixture<GetTotalVotingHoldersQuery>((query) => {
    query.securityId.as(() => HederaIdPropsFixture.create().value);
    query.voteId.faker((faker) => faker.number.int({ min: 1, max: 10 }));
  });
...
export const CreateTrexSuiteEquityCommandFixture =
  createFixture<CreateTrexSuiteEquityCommand>((command) => {
...
export const DividendFixture = createFixture<Dividend>((props) => {
  props.amountPerUnitOfSecurity.faker((faker) =>
    faker.number.int({ min: 1, max: 999 }),
  );
...
export const EquityDetailsFixture = createFixture<EquityDetails>((props) => {
  ...
  props.dividendRight.faker((faker) =>
    faker.helpers.arrayElement(Object.values(DividendType)),
  );
...
export const CreateTrexSuiteEquityRequestFixture =
  createFixture<CreateTrexSuiteEquityRequest>((request) => {
