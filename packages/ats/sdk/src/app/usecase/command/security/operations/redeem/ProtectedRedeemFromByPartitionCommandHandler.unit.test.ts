  ...
  describe('execute', () => {
    describe('error cases', () => {
      it('throws ProtectedRedeemFromByPartitionCommandError when command fails with uncaught error', async () => {
        ...
        await expect(resultPromise).rejects.toBeInstanceOf(
          ProtectedRedeemFromByPartitionCommandError,
        );

        await expect(resultPromise).rejects.toMatchObject({
          message: expect.stringContaining(
            `An error occurred while protected redeeming from tokens: ${errorMsg}`,
          ),
    ...
    describe('success cases', () => {
      it('should successfully protected redeem tokens', async () => {
        ...
        transactionServiceMock
          .getHandler()
          .protectedRedeemFromByPartition.mockResolvedValue({
            id: transactionId,
          });
        ...
        expect(
          transactionServiceMock.getHandler().protectedRedeemFromByPartition,
