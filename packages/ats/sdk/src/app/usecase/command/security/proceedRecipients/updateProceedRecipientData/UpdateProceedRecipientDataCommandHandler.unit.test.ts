  ...
  describe('execute', () => {
    it('throws UpdateProceedRecipientDataCommandError when command fails with uncaught error', async () => {
      ...
      await expect(resultPromise).rejects.toBeInstanceOf(
        UpdateProceedRecipientDataCommandError,
      );
      await expect(resultPromise).rejects.toMatchObject({
        message: expect.stringContaining(
          `An error occurred while updating proceed recipient data: ${errorMsg}`,
        ),
    ...
    it('should successfully update proceed recipient', async () => {
      ...
      transactionServiceMock
        .getHandler()
        .updateProceedRecipientData.mockResolvedValue({
          id: transactionId,
        });
      ...
      expect(
        transactionServiceMock.getHandler().updateProceedRecipientData,
